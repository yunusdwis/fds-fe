					...
					<div class="col-xl-12">
						<div class="row">
							<div class="col-xl-12">
                                ...
                                <p align="justify" style="">List of accounts that have been identified as fraudulent or high-risk based on FDS criteria, such as suspicious activity or a history of non-compliance with bank policies.
                                    There is also list of channel/device that temporarily disabled due to a compromise in security. This means that the security of these devices, channels, or ATMs has been breached and they are no longer considered safe to use. This could be due to a variety of reasons such as hacking, malware, or other malicious activity</p>
							</div>
						</div>
