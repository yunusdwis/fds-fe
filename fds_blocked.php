						...
						<div class="col-xl-12">
							<div class="page-titles style1">
								<div class="d-flex align-items-center">
									<h2 class="heading">List of Blocked Customer or Device</h2>
								</div>
							</div>
							<p align="justify" class="lead fs-4 px-3">
								List of accounts that have been identified as fraudulent or high-risk based on FDS criteria, such as suspicious activity or a history of non-compliance with bank policies.
							</p>
							<p align="justify" class="lead fs-4 px-3">
								There is also list of channel/device that temporarily disabled due to a compromise in security. This means that the security of these devices, channels, or ATMs has been breached and they are no longer considered safe to use. This could be due to a variety of reasons such as hacking, malware, or other malicious activity
							</p>
						</div>
					</div>
