				...
				<div class="row">
					<div class="col-xl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="mb-3">
							<a href="content-add.html" class="btn btn-primary">New Rule...</a>
						</div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <td><strong>1</strong></td>
                                                ...
                                                <td>FR001</td>
                                                <td>High</td>
                                                <td>Simultaneous transaction from the same device</td>
                                            </tr>
											<tr>
                                            <td><strong>2</strong></td>
                                                ...
                                                <td>FR002</td>
                                                <td>High</td>
                                                <td>Simultaneous transaction using same card from different location</td>
                                            </tr>
											<tr>
